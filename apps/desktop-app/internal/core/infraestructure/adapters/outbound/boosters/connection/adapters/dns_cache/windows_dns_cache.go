...
func NewDNSCacheExecutor(services *inbound.ExecutorDepServices) *WindowsDNSExecutor {
	return &WindowsDNSExecutor{}
}

func (e *WindowsDNSExecutor) Execute(ctx context.Context, boosterID string) (*entities.BoostApplyResult, error) {
...
func (e *WindowsDNSExecutor) Revert(ctx context.Context, backupData entities.BackupData) (*entities.BoostRevertResult, error) {
