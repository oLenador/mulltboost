...
type BoosterService interface {
	...
	InitRevertBooster(ctx context.Context, id string) (entities.InitResult, error)
	InitRevertBoosterBatch(ctx context.Context, ids []string) (entities.InitResult, error)
}
